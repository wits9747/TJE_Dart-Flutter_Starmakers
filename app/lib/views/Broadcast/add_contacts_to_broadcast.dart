                                                                              ...
                                                                              children: [
                                                                                WidgetSpan(
                                                                                  child: Padding(
                                                                                    ...
                                                                                    child: Icon(
                                                                                      Icons.contact_page,
                                                                                      color: lamatPRIMARYcolor.withOpacity(0.7),
                                                                                      size: 14,
                                                                                    ),
                                                                                  ),
                                                                                ),
                                                                                TextSpan(text: "No Saved Contacts", style: TextStyle(color: lamatSECONDARYolor.withOpacity(0.7), height: 1.3, fontSize: 13, fontWeight: FontWeight.w400)),
                                                                              ],
                                                                            ),
                                                                          )),
                                                                ),
                                                                      ...
                                                                      ListTile(
                                                                        ...
                                                                        trailing:
                                                                          ...
                                                                          decoration:
                                                                              BoxDecoration(
                                                                            border:
                                                                                Border.all(color: lamatGrey, width: 1),
                                                                            borderRadius:
                                                                        ...
                                                                        title: Text(
                                                                            ...
                                                                            style:
                                                                                TextStyle(
                                                                              color: pickTextColorBasedOnBgColorAdvanced(Teme.isDarktheme(widget.prefs) ? lamatCONTAINERboxColorDarkMode : lamatCONTAINERboxColorLightMode),
                                                                            )),
                                                                        subtitle: Text(
                                                                            phone,
                                                                            style:
