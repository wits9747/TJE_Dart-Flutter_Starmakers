...
String errorCode(String err) {
  ...
  switch (err) {
    ...
    case "7024":
      s = "You have installed a single project mutliple times using the same Extended License. kindly create a project and then proceed for another Installation. Thank you!";
      break;
